...
begin
for i in(
SELECT 'CUSTOMER_ADDRESS' TABLE_NAME from dual union all
...
/
insert into customer_contact (ID, MOBILE_NO, EMAIL)
...
/
INSERT INTO SALES_REP_ACTIVITY(MEETING_ID,SALESREP_ID,CUSTOMER_NAME,INTERACTION_TYPE,CUSTOMER_TYPE,INTERACTION_DATE,INTERACTION_DURATION,COMMENTS,ADDRESS_LINE_1,ADDRESS_LINE_2,CITY,REGION,STATE,ZIPCODE,CUSTOMER_CONVERTED_FLAG)
...
select 723004, 223004, 6601, 350 from dual union all
select 723005, 223005, 6601, 350 from dual union all
select 723006, 223001, 6602, 350 from dual union all
select 723007, 223002, 6602, 350 from dual union all
select 723008, 223003, 6602, 350 from dual union all
select 723009, 223004, 6602, 350 from dual union all
select 723010, 223005, 6602, 350 from dual union all
select 723011, 223001, 6603, 350 from dual union all
select 723012, 223002, 6603, 350 from dual union all
